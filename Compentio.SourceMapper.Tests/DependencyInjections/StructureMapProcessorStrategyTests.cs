...
{
    public class StructureMapProcessorStrategyTests
    {
        private readonly IFixture _fixture;
        private readonly Mock<ISourcesMetadata> _mockSourceMetadata;
        private const string BuilderRegisterService = "builder.For";

        public StructureMapProcessorStrategyTests()
        {
            _fixture = new Fixture();
            _mockSourceMetadata = _fixture.Create<Mock<ISourcesMetadata>>();
            _mockSourceMetadata.Setup(m => m.DependencyInjection).Returns(new SourceMapper.Processors.DependencyInjection.DependencyInjection() { DependencyInjectionType = DependencyInjectionType.StructureMap });
        }
        ...
        public void GenerateCode_WithoutMappers_ReturnProperResult()
        {
            ...
            // Act
            var structureMapProcessorStrategy = new StructureMapProcessorStrategy();
            var result = structureMapProcessorStrategy.GenerateCode(_mockSourceMetadata.Object);
